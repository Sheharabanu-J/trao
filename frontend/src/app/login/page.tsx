  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
      <form onSubmit={submit} className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-6">
        ...
        <p className="text-sm text-slate-400 mb-6">Access your private itineraries.</p>
        ...
        <div className="text-center text-sm text-slate-400 mt-4">
          No account? <a className="text-indigo-300 hover:underline" href="/register">Register</a>
        </div>
      </form>
    </div>
  );
